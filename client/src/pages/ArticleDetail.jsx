...
export default function ArticleDetail() {
    ...
    // Prefer route state from the clicked card, then fall back to saved storage
    // so refreshing the detail page can still find the article.
    const article =
        location.state?.article ||
        savedArticles.find((savedArticle) => savedArticle.id === decodedArticleId);
